...
<Seo
	title="Misc"
	description="Miscellaneous writings by quantinium — rants, notes and everything that doesn't fit elsewhere."
/>

<div class="py-4">
	<div class="mx-1 flex items-center justify-between">
		<h1 class="font-bold">
			Misc <span class="text-sm font-normal opacity-70">({filtered.length})</span>
		</h1>
		<input
			type="search"
			placeholder="search..."
	...
	{#if filtered.length === 0}
		<p class="pt-4 text-sm opacity-50">nothing here yet.</p>
	{:else}
		<div class="pt-4">
