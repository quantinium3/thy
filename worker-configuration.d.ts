/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 85b34d6d0957659e284ef5556e3abc54)
// Runtime types generated with workerd@1.20260526.1 2026-05-28 nodejs_als
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	VITE_TIME_URI: string;
	VITE_LANG_URI: string;
	VITE_ERIS_URI: string;
}
